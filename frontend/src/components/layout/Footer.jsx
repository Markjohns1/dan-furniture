                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <a href="tel:+254700000000" className="text-primary-200/70 hover:text-white transition-colors flex items-center gap-2">
                                    <i className="fas fa-phone w-4"></i> +254 700 000 000
                                </a>
                            </li>
                            <li>
